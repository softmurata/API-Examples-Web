                    ...
                    yield Promise.all(
                      nodesUsingMesh.map((nodeIndex) =>
                        __awaiter(this, void 0, void 0, function* () {
                          var _b
                          const primitives =
                            yield gltfExtractPrimitivesFromNode(gltf, nodeIndex)
  ...
  class VRMFirstPerson {
    ...
    getFirstPersonWorldDirection(target) {
      return target
        ...
        .applyQuaternion(getWorldQuaternionLite(this._firstPersonBone, _quat$1))
    }
    /**
  ...
  class VRMImporter {
    ...
    import(gltf) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const materials =
          (yield this._materialImporter.convertGLTFMaterials(gltf)) || undefined
        const humanoid =
